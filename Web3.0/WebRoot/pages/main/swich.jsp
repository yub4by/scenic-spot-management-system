...
<html>
  <head>
    ...
    <title>My JSP 'swich.jsp' starting page</title>
	...
	<script language="javascript">
		function switchSysBar(){
		 if (parent.document.getElementById('attachucp').cols=="180,8,*,10"){
		 document.getElementById('leftbar').style.display="";
		 parent.document.getElementById('attachucp').cols="0,8,*,0";
		 }
		 else{
		 parent.document.getElementById('attachucp').cols="180,8,*,10";
		 document.getElementById('leftbar').style.display="none"
		 }
		}
		function load(){
		 if (parent.document.getElementById('attachucp').cols=="0,8,*,0"){
		 document.getElementById('leftbar').style.display="";
		 }
		}
	</script>
