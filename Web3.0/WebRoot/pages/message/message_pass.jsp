...
<html>
  <head>
    ...
    <title>My JSP 'message_pass.jsp' starting page</title>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    ...
    <div class="place"><span>您的位置：留言管理 > 审核留言</span></div>
    </td>
  </tr>
  <tr>
			...
			<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
				...
				<td align="center" valign="middle" class="borderbottom">
 				<a href="MessageServlet?flag=pas&id=${msg.id }" onclick="return confirm('确定通过审核吗？')" target="mainFrame" onFocus="this.blur()" class="add" >
 					<img src="images/main/addinfoblue.jpg" />审核
 				</a>
 				&nbsp;|&nbsp;
 				<a href="MessageServlet?flag=hupas&id=${msg.id }" onclick="return confirm('确定恢复该留言为为审核状态吗？')" target="mainFrame" onFocus="this.blur()" class="add" >
 					<img src="images/main/exiton.jpg" />恢复
 				</a>
				</td>
			</tr>
  	 </c:forEach>
