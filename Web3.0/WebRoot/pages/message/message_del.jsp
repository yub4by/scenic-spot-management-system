...
<html>
  <head>
    ...
    <title>My JSP 'message_del.jsp' starting page</title>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    ...
    <div class="place"><span>您的位置：留言管理 > 删除留言</span></div>
    </td>
  </tr>
  <tr>
			...
			<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
				...
				<td align="center" valign="middle" class="borderbottom">
 				<a href="MessageServlet?flag=del&id=${msg.id }" onclick="return confirm('确定删除留言吗？')" target="mainFrame" onFocus="this.blur()" class="add" >
 					<img src="images/main/exiton.jpg" />删除
 				</a>
 				&nbsp;|&nbsp;
 				<a href="MessageServlet?flag=hudel&id=${msg.id }" onclick="return confirm('确定恢复留言吗？')" target="mainFrame" onFocus="this.blur()" class="add" >
 					<img src="images/main/addinfoblue.jpg" />恢复
 				</a>
				</td>
			</tr>
  	 </c:forEach>
